...
<template>
  <div style="display: flex; max-width: 28rem; margin: 0 auto; padding: 1.5rem 0; background-color: white; border-radius: 0.5rem; border: 1px solid rgba(0, 0, 0, 0.15)">
    <div style="width: 40%; margin: auto; font-weight: 500; text-align: center; text-wrap: balance">{{ homework(trip.from) }}</div>
    ...
    <div style="width: 40%; margin: auto; font-weight: 500; text-align: center; text-wrap: balance">{{ homework(trip.to) }}</div>
  </div>
</template>
