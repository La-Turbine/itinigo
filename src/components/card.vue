...
<template>
  <div style="display: flex; max-width: 28rem; margin: 0 auto; padding: 1.5rem 0; background: #f6f7f7; border-radius: 0.5rem; border: 1px solid rgba(0, 0, 0, 0.15)" v-if="trip">
